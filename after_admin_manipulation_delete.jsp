    ...
    <head>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="hovereffect">
                ...
                <div class="overlay">
                    ...
                    <a class="info" href="delete_package.jsp">Delete Package</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="hovereffect">
                ...
                <div class="overlay">
                    <!--           <h2>Hover effect 1</h2>-->
                    <a class="info" href="delete_hotel.jsp">Delete Hotels</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="hovereffect">
                ...
                <div class="overlay">
                    <!--           <h2>Hover effect 1</h2>-->
                    <a class="info" href="delete_cities.jsp">Delete Cities</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="hovereffect">
                ...
                <div class="overlay">
                    <!--           <h2>Hover effect 1</h2>-->
                    <a class="info" href="delete_package_cities.jsp">Delete Package Cities</a>
                </div>
            </div>
        </div>
         ...
         <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="hovereffect">
                ...
                <div class="overlay">
                    <!--           <h2>Hover effect 1</h2>-->
                    <a class="info" href="delete_dates.jsp">Delete Date Availability</a>
                </div>
            </div>
        </div>
