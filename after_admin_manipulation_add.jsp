    ...
    <head>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="hovereffect">
                ...
                <div class="overlay">
                    ...
                    <a class="info" href="add_package.jsp">Add Package</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="hovereffect">
                ...
                <div class="overlay">
                    <!--           <h2>Hover effect 1</h2>-->
                    <a class="info" href="add_hotels.jsp">Add Hotels</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="hovereffect">
                ...
                <div class="overlay">
                    <!--           <h2>Hover effect 1</h2>-->
                    <a class="info" href="add_cities.jsp">Add Cities</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="hovereffect">
                ...
                <div class="overlay">
                    <!--           <h2>Hover effect 1</h2>-->
                    <a class="info" href="add_package_cities.jsp">Add Package Cities</a>
                </div>
            </div>
        </div>
         ...
         <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="hovereffect">
                ...
                <div class="overlay">
                    <!--           <h2>Hover effect 1</h2>-->
                    <a class="info" href="add_package3.jsp">Add Date Availability</a>
                </div>
            </div>
        </div>
