...
<html>
    ...
    <body>
        ...
        <center>
            <form action="delete_package_cities.jsp">
            
                    
            <h2 style="display:inline-block"> Enter the city ID  <input type="text" name="id"/></h2>
...
String sql = "DELETE FROM package_cities WHERE city_id="+personID;
